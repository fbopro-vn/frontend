...
// const ModalAddProduct: React.FC<AddProductModalProps> = ({ open, handleClose, onAddProduct }) => {
//     const {
//         register,
//         handleSubmit,
//         formState: { errors },
...
//                 nhom_san_pham: data.groupPro,
//                 don_vi_tinh: data.unit,
//                 gia_von: Number(data.costPrice), // Chuyển sang số nếu cần
//                 gia_ban: Number(data.salePrice),
//                 ton_kho: Number(data.stockQuantity)
//             }, {
...
//             onAddProduct(response.data); // Trả kết quả về component cha nếu cần
//             mutate("http://192.168.1.203:8000/qlybanhang/add-cate");

//             reset();
//             handleClose();
//         } catch (err) {
//             console.error("❌ Lỗi khi gửi dữ liệu:", err);
//             setErrorForm("Không thể lưu sản phẩm, vui lòng thử lại!");
//         } finally {
//             setLoading(false);
//         }
//     };
...
//                     ) : (<Box component='form' onSubmit={handleSubmit(onSubmit)} display="grid" gridTemplateColumns="1fr 1fr" gap={4} p={4}>
...
//                                 disablePortal
//                                 freeSolo
//                                 options={getFromLocalStorage("productGroups") || []} // Đảm bảo không null
//                                 renderInput={(params) => (
//                                     <TextField
//                                         {...params}
//                                         sx={{
...
//                                             overflowY: "auto", // Hiển thị thanh cuộn nếu có quá nhiều lựa chọn
//                                         },
//                                     },
//                                 }}
//                                 // {...register("groupPro", {
//                                 //     required: "Nhóm sản phẩm không được để trống",
//                                 //     minLength: { value: 2, message: "Nhóm sản phẩm phải có ít nhất 3 ký tự" },
//                                 //     maxLength: { value: 30, message: "Nhóm sản phẩm không được vượt quá 30 ký tự" }
//                                 // })}
//                             />

// {/* <Typography sx={{ minHeight: "20px", fontSize: "15px", color: "red", mt: 0.5 }}>
//                     {errors.groupPro?.message}
//                 </Typography> */}
//                         </Box>
//                         <Box display="flex" flexDirection="column">
...
//                                 disablePortal
//                                 freeSolo
//                                 options={getFromLocalStorage("unitTypes") || []} // Đảm bảo không null
//                                 renderInput={(params) => (
//                                     <TextField
//                                         {...params}
//                                         sx={{
...
//                                 //     minLength: { value: 2, message: "Đơn vị tính phải có ít nhất 3 ký tự" },
...
//                                     minLength: { value: 4, message: "Giá vốn phải có ít nhất 3 ký tự" },
//                                     maxLength: { value: 30, message: "Giá vốn không được vượt quá 30 ký tự" }
//                                 })}
//                             />
// {/* // <Typography sx={{ minHeight: "20px", fontSize: "15px", color: "red", mt: 0.5 }}>
...
//                                 bgcolor: "#8DB883",
//                                 width: "100px"
//                             }}>{loading ? <CircularProgress size={24} sx={{ color: "white" }} /> : "Lưu"}</Button>
//                         </Box>
//                     </Box>)}
...
//             {/* Dialog dùng chung cho cả Nhóm Sản Phẩm & Đơn Vị Tính */}
                ...
                <Typography sx={{ color: "red", textAlign: "center", fontSize: "15px" }}>
                    {errorForm}
                        ...
                        <Button variant="outlined" sx={{ color: "#8DB883", border: "1px solid #8DB883", width: "100px", "&:hover": { backgroundColor: "rgba(141, 184, 131, 0.1)", border: "1px solid #8DB883" } }} onClick={() => {
                                reset(),
                                setErrorForm(""),
                                handleClose()}} disabled={isLoading} >Bỏ qua</Button>
                        <Button type="submit" variant="contained" sx={{ bgcolor: "#8DB883", width: "100px" }} disabled={loading}>{loading ? <CircularProgress size={24} sx={{ color: "white" }} /> : "Lưu"}</Button>
                    </Box>
                </Box>)}
            </Box>
        </Modal>
